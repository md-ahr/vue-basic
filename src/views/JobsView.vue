      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md relative">
          <div class="p-4">
            ...
            <div class="mb-5">
              ...
              Pheonix, AZ. We are looking for a self-motivated individual with a
              passion...
            </div>
        ...
        <div class="bg-white rounded-xl shadow-md relative">
          <div class="p-4">
            ...
            <div class="mb-5">
              Join our team as a Front-End Developer in beautiful Portland, OR.
              We are looking for a skilled and enthusiastic individual...
            </div>
